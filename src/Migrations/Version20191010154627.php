 ...
 */
final class Version20191010154627 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD manga_id INT NOT NULL, ADD illustration_id INT NOT NULL, ADD ima_nom_fichier VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE news ADD utilisateur_id VARCHAR(40) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
